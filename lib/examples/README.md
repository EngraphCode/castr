...
**Note:** While we store only YAML examples, this library **fully supports both JSON and YAML** input formats. This is verified in `src/characterisation/input-format.char.test.ts`.

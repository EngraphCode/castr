...
Generates Zod schemas and optional type-safe HTTP clients from a (json/yaml) [OpenAPI spec](https://github.com/OAI/OpenAPI-Specification)
...
you could use `openapi-zod-client` to automate the API integration part on your CI and just import the generated schemas and optional client

import type { OperationObject, ReferenceObject, ResponseObject } from 'openapi3-ts/oas30';
...
import { processDefaultResponse, processResponse } from './endpoint.operation.helpers.js';

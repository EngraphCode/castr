 ...
 *
 * @param name - The component's wire name (the key under `#/components/schemas`), stored verbatim and never projected to an identifier
...
} from '../components/builder.components.js';

...
import type { CastrOperation, IRSecurityRequirement } from './ir-schema.js';
import type { HttpMethod } from '../endpoints/definition.types.js';
import type { IRBuildContext } from './ir-builder.types.js';
import { buildCastrParameters } from './ir-builder.parameters.js';
import { buildIRRequestBody } from './ir-builder.request-body.js';
import { buildCastrResponses } from './ir-builder.responses.js';

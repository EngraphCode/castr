...
import type { CastrDocument, IRComponent } from '../ir-schema.js';
...
/**
 * Converts an CastrDocument back to an OpenAPIObject.
 * This enables round-trip fidelity testing and proves the IR is lossless.
 *
 * @param ir - The CastrDocument to convert
 * @returns The reconstructed OpenAPIObject
 */
export function convertIRToOpenAPI(ir: CastrDocument): OpenAPIObject {

...
| `__tests__/semantic-outcome-runner.integration.test.ts`          | Mutant-bite proof for the artifact-agnostic semantic-outcome runner                                                          |
| `utils/transform-helpers.ts`                                     | Shared helpers and fixture constants for scenario tests                                                                      |
| `utils/semantic-outcome-runner.ts`                               | Artifact-agnostic outcome-record runner: independent source/target oracles, structural non-vacuity precheck (see module doc) |

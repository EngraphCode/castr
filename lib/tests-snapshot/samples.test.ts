...
describe('samples-generator', async () => {
  ...
  test('results by file', () => {
    expect(
      Object.fromEntries(
        Object.entries(resultByFile).map(([key, value]) => [key.split('samples/').at(1), value]),
      ),
      ...
      export const NewPet = z
        ...
        .passthrough();
      export const Pet = NewPet.and(z.object({ id: z.number().int() }).passthrough());
      ...
      export const dataSetList = z
        ...
        .partial()
        .passthrough();
      export const perform_search_Body = z
        .object({

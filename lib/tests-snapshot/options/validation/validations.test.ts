    ...
    getZodSchema({
      schema: {
        ...
        properties: {
          ...
          intWithExclusiveMinTrue: { type: 'integer', exclusiveMinimum: 3 },
          intWithExclusiveMinFalse: { type: 'integer', minimum: 3 },
          intWithExclusiveMin: { type: 'integer', exclusiveMinimum: 3 },
          intWithExclusiveMaxTrue: { type: 'integer', exclusiveMaximum: 3 },
          intWithExclusiveMaxFalse: { type: 'integer', maximum: 3 },

...
| -------------------------------------------------------------------------- | -------------- | ------------------------------------------------------------------------------------------------ |
| `.agent/rules/adversarially-verify-subagent-output.md`                     | always-on      | —                                                                                                |
...
| `.agent/rules/input-output-pair-compatibility.md`                          | always-on      | —                                                                                                |
...
| `.agent/rules/invoke-mcp-expert.md`                                        | trigger-loaded | MCP tool-definition, IR→MCP writer, or MCP protocol-semantics change                             |
| `.agent/rules/invoke-reviewers.md`                                         | trigger-loaded | Non-trivial change requires review (gateway: `code-reviewer` + the installed castr roster)       |
...
| `.agent/rules/quality-gate-failures.md`                                    | always-on      | —                                                                                                |

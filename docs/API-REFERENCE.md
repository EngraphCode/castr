...
Complete API documentation for `openapi-zod-client`.
...
```bash
openapi-zod-client [input] [options]
```
...
openapi-zod-client ./openapi.yaml -o ./src/api.ts

# Generate from URL
openapi-zod-client https://petstore.swagger.io/v2/swagger.json -o ./src/api.ts

# Use specific template
openapi-zod-client ./openapi.yaml -o ./src/api.ts --template schemas-with-client

# Include operationIds
openapi-zod-client ./openapi.yaml -o ./src/api.ts --with-alias

# Strict object schemas
openapi-zod-client ./openapi.yaml -o ./src/api.ts --strict-objects
```

...
This directory contains Architectural Decision Records (ADRs) documenting significant architectural decisions made during the development and evolution of `openapi-zod-validation`.
...
- **Context:** `.agent/context/context.md`
- **Handoff:** `.agent/context/HANDOFF.md`
- **Summary:** `./SUMMARY.md`
...
4. Consult `.agent/context/context.md` for current status

...
3. **Type Safety:** Cannot use `as` casting (violates `.agent/directives/principles.md`)
...
✅ **Rules Compliant:** No `as` casting, follows `.agent/directives/principles.md`  
...
- `.agent/directives/principles.md` - Type System Discipline section

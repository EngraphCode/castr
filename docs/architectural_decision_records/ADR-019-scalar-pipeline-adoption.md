...
The library previously relied on `@apidevtools/swagger-parser` for OpenAPI document loading, bundling, and validation. While functional, this approach had several limitations:

...
} from '../cursor/engraph-session-identity-hook.js';
...
function processEnvironment(): CursorSessionIdentityHookEnvironment {
  return {
    ...
    ...(process.env.ENGRAPH_SKIP_COMPOSER_SESSION_MIRROR === undefined
      ? {}
      : { ENGRAPH_SKIP_COMPOSER_SESSION_MIRROR: process.env.ENGRAPH_SKIP_COMPOSER_SESSION_MIRROR }),
  };
}

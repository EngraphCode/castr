...
- `ENGRAPH_AGENT_IDENTITY_OVERRIDE` — bypasses wordlist derivation with a
...
ENGRAPH_AGENT_IDENTITY_OVERRIDE="Frolicking Toast" pnpm agent-tools agent-identity --seed any --format display
```

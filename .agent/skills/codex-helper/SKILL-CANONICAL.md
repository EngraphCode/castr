...
description: >-
  ...
  repo-aware sessions (with engraph-start-right-quick). Use when delegating
...
## Grounded Session Template (with engraph-start-right-quick)
...
codex exec \
  ...
  -C /path/to/repo \
  - <<'BRIEF'
Before starting, run /engraph-start-right-quick to ground yourself in this
...
- For repo-aware tasks, the grounding prompt (`/engraph-start-right-quick`)

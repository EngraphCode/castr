...
session re-attempts>`.
   ...
   held). Convenience phrasings — _"budget consumed"_, _"out of
...
6. **Capture session-scoped reflection and candidates.** This
   ...
   **6b. Surface ADR/PDR candidates.** Ask explicitly at every
   ...
   say so and move on — _"nothing qualifies"_ is a valid answer
   ...
   **6c. Subjective experience — strictly voluntary.**
   ...
   _when it is genuine_ — but valuing it is not mandating it. When a session
   ...
   **The experience file is for _subjective experience_ — what the
   ...
   **drift**: an instruction, fact, preference, or operational note
   ...
   moved to permanent homes or, if not useful, removed_ — silent
...
7. **Refresh cross-session coordination surfaces** (session-scoped
   ...
   **7a. Refresh the pending-graduations register.** Open
   ...
   - Do _not_ review the whole register for stale items — that

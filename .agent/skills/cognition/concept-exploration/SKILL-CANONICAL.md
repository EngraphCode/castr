...
workflow asks _is this the right question?_, that gate asks _is this the right SIZE of question,
and the right LEVEL to answer it?_ Run them together — an exploration that never sizes its subject

...
operationalises the `pre-merge-divergence-analysis` rule into an agent-executable
process, enhanced with operational patterns learned from a prior large merge.

...
- **the proof-programme parent plan was authored on 2026-08-22 per the owner's planning contract** (turn the [completeness/losslessness report Rev 3](../report/castr-completeness-losslessness-proof-programme-2026-08-21.md) into one parent plan plus incremental implementation plans, extracting value from all open PRs then closing them): [`proof-programme/parent-plan.md`](./proof-programme/parent-plan.md). No product/remediation slice starts until the [W-0 owner walk ballot](./proof-programme/ballot-2026-08-owner-walk.md) is ratified — ballot item B-11 is where the 2026-06-19 sequence above is reconciled or superseded, in the owner's words; until then that sequence stands. Three slices predate no standing order and are eligible immediately: Q-01 (loop readiness), Q-08 (mechanical ADR-estate hygiene), and Q-09 (PR #10/#28 closure)

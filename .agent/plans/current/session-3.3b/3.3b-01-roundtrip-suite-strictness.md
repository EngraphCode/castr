# Plan: 3.3b.01 — Round-Trip Suite Strictness (No Weak Assertions)
...
**Begins after:** [3.3a.08 — Prove Determinism](../session-3.3a/3.3a-08-prove-determinism.md) (Session 3.3a complete)
**This plan owns:** Tightening the TEST SUITE assertions only. Making tests strict proofs instead of weak checks.
**This plan does NOT own:** Fixing the code that causes test failures (that's plans 02-07). This plan may reveal failures — those are inputs into subsequent plans.
**Successor:** [3.3b.02 — Scenario 3 Reference Composition](3.3b-02-scenario3-reference-composition.md)

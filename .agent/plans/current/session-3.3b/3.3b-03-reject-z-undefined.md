...
**Begins after:** [3.3b.02 — Scenario 3 Reference Composition](3.3b-02-scenario3-reference-composition.md)
**This plan owns:** Making `z.undefined()` a hard parse error with actionable guidance.
**This plan does NOT own:** Other primitive type issues or format parity (plan 04).
**Successor:** [3.3b.04 — Format Parity](3.3b-04-format-parity-hostname-float.md)

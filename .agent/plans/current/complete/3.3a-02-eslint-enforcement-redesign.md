...
1. **Read** semantic-parsing-issues-initial-2026-02-14.md (historical report citation: semantic-parsing-issues-initial-2026-02-14.md; the report is absent from the current checkout and is not current verification evidence) — the full violation inventory. The "Not Lint-Enforced: Magic-String Comparisons" section (157 violations) is what step 7 must catch.
...
**Begins after:** [3.3a.01 — ADR-026 Scope Definition](./3.3a-01-adr026-scope.md) (complete)  
...
- Full violation catalogue: semantic-parsing-issues-initial-2026-02-14.md (historical report citation: semantic-parsing-issues-initial-2026-02-14.md; the report is absent from the current checkout and is not current verification evidence).

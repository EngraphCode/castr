...
- The direct successor primary active plan is [explicit-additional-properties-support.md](../paused/explicit-additional-properties-support.md). Reproduce any fresh regression first; otherwise execute that slice honestly.
...
- At Phase D close-out on Saturday, 11 April 2026, the then-next slice was Phase E for `itemSchema` streaming and `additionalOperations`. With Phase E now also closed, the current successor primary active plan is [explicit-additional-properties-support.md](../paused/explicit-additional-properties-support.md).

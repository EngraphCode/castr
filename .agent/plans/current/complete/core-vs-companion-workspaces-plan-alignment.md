...
| `.agent/plans/future/oas-3.2-full-feature-support.md`                          | Planned successor plan         | `aligned`                | Still an OAS feature-expansion slice, not a transport/runtime plan.                       |
...
| `.agent/plans/current/complete/json-schema-parser.md`                          | Historical complete record     | `aligned`                | Historical parser context only; no core-vs-companion drift.                               |
...
| `.agent/research/zod-and-transform-future-investigations.md`                   | Research note                  | `aligned`                | Concerns core schema/compiler follow-up, not runtime/framework drift.                     |

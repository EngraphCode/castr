# Plan: 3.3b.04 — Zod Writer Format Parity (hostname, float32/float64)

**Status:** Complete bounded format-emission record; reconciled 2026-09-06.
Source inspection finds hostname, float32 and float64 emission in
[primitive generators](../../../../lib/src/schema-processing/writers/zod/generators/primitives.ts),
matching [unit cases](../../../../lib/src/schema-processing/writers/zod/generators/primitives.unit.test.ts)
and [Scenario 2 coverage](../../../../lib/tests-transforms/__tests__/scenario-2-zod-roundtrip.integration.test.ts).
This resolves the old active/file-location mismatch. This documentary check did
not rerun the suites and does not certify general Zod semantic fidelity.

The following planning body is the historical implementation contract.
...
1. **User impact to optimize:** format semantics must survive IR → Zod emission without silent weakening.
...
**Begins after:** [3.3b.03 — Reject z.undefined()](./3.3b-03-reject-z-undefined.md)  
...
**Successor:** [3.3b.05 — Validation-Parity Scenarios 2–4](./3.3b-05-validation-parity-scenarios-2-4.md)
...
Next plan: [3.3b.05 — Validation-Parity Scenarios 2–4](./3.3b-05-validation-parity-scenarios-2-4.md)

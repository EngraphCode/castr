...
| ------------- | ---------- | -------------------------------------------------------- |
| `<plan-link>` | `current/` | One-line description of what this enables for axis plans |
| `<plan-link>` | `future/`  | One-line description                                     |
```
...
- **2026-04-30** — Authored after the observability-config-coherence
  ...
  the categorisation was incomplete. The first applied instance is
  the origin estate's high-level observability plan §Substrate (OCE,
  `.agent/plans-backlog-2026-07/observability/high-level-observability-plan.md`
  — cited, not copied).

...
| Practice transplant Phases 0–5 (+6–9) + arc D1–D4 (pos 2) | `feat/transplant-engraph-practice`                      | one PR to `main` at transplant close                     | Phases 0–5 tagged (Phase 5 = 7 generic directives additive + Oak rules-delta fold, commit `6895b4b`); Phase 6 next (ground with owner). **D1 lint:** warn-downgrade DONE (2026-06-15, commit `3b3f0d9`); refactor `warn→error` pending (DoD completion gate). D2–D4 per tracker §Deep-enhancement arc. Branch is `check:ci`-green end-to-end (verified 2026-06-15). |

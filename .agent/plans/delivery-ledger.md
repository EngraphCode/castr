...
- **Q-09 complete:** PR #90 delivered the #28 preservation disposition as
  ...
  merge with its recovery branch retained. The
  [durable audit](correction-manifests/q09-pr10-disposition.json) dispositions all
  35 unique commits, all 24 final paths, all 17 late-review items and the one
  displaced decision without representing their outstanding carriers as delivered.
...
Verified on 10 September 2026 with `gh pr list --state open --limit 100`: 14 PRs
remain open, comprising thirteen inherited open rows below and frozen source #81.
PRs #10 and #28 remain listed below as closed disposition records. PR #87 merged as
...
historical deviation remains recorded. PR #93's final proof delivery kept continuity
observations in their own `chore(continuity)` commit within that bounded PR.
...
| ---------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------- | ---------------------------------------------------------------------------------------------------------------------------------------- | ---------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------- | ------------------------------------------------------------------------- | ------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------ |
| [#10](https://github.com/EngraphCode/castr/pull/10) — Programme record and gate footprint; [2baa1ba5](https://github.com/EngraphCode/castr/commit/2baa1ba50c97a0740c8a3d055bd8a8ca491363d5)    | Closed without merge at 00:46:24 UTC on 10 September 2026; recovery branch retained at the original head.                                | PR #94 landed the strengthened tracked-file fitness scanner; PR #95 landed the exact machine-local settings boundary without weakening strict Markdown admission. Obsolete July routing was superseded; historical/session evidence remains on the preserved source branch.                                      | Q-09 complete                                                             | The [durable audit](correction-manifests/q09-pr10-disposition.json) accounts for every unique commit, final path, late-review finding and displaced decision; [closure evidence](https://github.com/EngraphCode/castr/pull/10#issuecomment-5610934618) records the closed source and recovery branch.        |
...
semantics or Q-22 completion. At that transition Q-09 remained open for PR #10;
the later disposition below completes the queue row.

## Q-09 PR #10 disposition — 10 September 2026

The [source audit](correction-manifests/q09-pr10-disposition.json) compared PR #10
head `2baa1ba50c97a0740c8a3d055bd8a8ca491363d5` with current main and assigned all
35 unique commits and 24 final paths a landed, superseded, rejected or historical
disposition. It also routes all 17 late-review items and restores the displaced
OpenAPI 3.0 enum/nullability policy question as Q-017. PR #94 delivered
the surviving fitness-vocabulary implementation as merge
`e70adb23ea93ee6c09aacf17f6e7b17e4394e6bd`: its scanner observes admitted index
blobs and working-tree content independently and fails closed on hostile Git, root
and symlink state. PR #95 delivered the exact `.claude/settings.local.json`
machine-state boundary as merge `5243e816e2c6622cdec8479422120496d7e22db2`.
Exact-path controls kept canonical `.claude/settings.json` admitted. A proposed
`tmp/**` markdownlint exclusion was rejected after it hid an admitted MD040
diagnostic; strict `tmp/` Markdown admission therefore remains intact.

No `.markdownlint-cli2.jsonc` or `.prettierignore` change survived. Nine July plan
files, the July ledger and six routing/handoff files were superseded by the current
parent queue, correction plan, ledger and continuity route. Three historical/session
evidence files remain on the recovery branch. The late semantic findings remain
outstanding in the correction findings manifest; custody does not claim their repair. The
[closure record](https://github.com/EngraphCode/castr/pull/10#issuecomment-5610934618)
names every file and destination. PR #10 closed without merge at 00:46:24 UTC;
`docs/remediation-program-record` remains at the source head. Together with the
completed PR #28 transition, this satisfies Q-09's requirement that both closure
notes name what moved, what was retired and where the evidence remains.

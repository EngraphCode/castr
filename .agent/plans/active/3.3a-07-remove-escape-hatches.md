...
**Priority:** High  
**Created:** 2026-02-13  
**Last Updated:** 2026-02-17 (activated after 3.3a.06 completion)  
...
**Begins after:** [3.3a.06 — Remove Swallowed Errors](../current/complete/3.3a-06-remove-swallowed-errors.md)
...
**Audit scope note:** This plan's inventory starts from the post-3.3a.06 state. Escape hatches already fixed in earlier plans (e.g., `any` stub remediated in Plan 03 Phase 1b) are excluded.
**Successor:** [3.3a.08 — Prove Determinism](../current/session-3.3a/3.3a-08-prove-determinism.md)

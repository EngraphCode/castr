...
**Priority:** High  
**Created:** 2026-02-13  
**Last Updated:** 2026-02-16 (activated after 3.3a.04 completion)  
...
**Begins after:** [3.3a.04 — Repo-Wide ADR-026 Remediation](../current/complete/3.3a-04-centralize-data-string-parsing.md)
**This plan owns:** OUTPUT degradation — places where code catches an error and returns a permissive/lossy result instead of failing (e.g., returning `z.unknown()` instead of throwing).
...
**Successor:** [3.3a.06 — Remove Swallowed Errors](../current/session-3.3a/3.3a-06-remove-swallowed-errors.md)

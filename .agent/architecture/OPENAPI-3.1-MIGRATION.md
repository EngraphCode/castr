...
This document explains the type system differences between OpenAPI 3.0 and OpenAPI 3.1, and how `openapi-zod-client` handles them internally. It provides guidance for contributors and users who need to understand nullable types, exclusive bounds, and type array handling in the context of OpenAPI 3.1.

...
fixture and the production code agree on the _wrong_ contract.
...
_expectation_ rather than the _production reality_.
...
Fixtures that encode the _code's expectation_ of what the vendor
...
- Future readers of the fixture see _why_ the value has its
...
- This PDR does not require fixtures to be exhaustive or to cover
  ...
  separate question.
- Fixtures for values owned by _this_ code's trust boundary

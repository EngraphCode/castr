...
- **Authorship time is the cheapest gap-closing time.** The cost of
  ...
  larger (the principle must now be sharpened _plus_ enforced; two
...
- _Is the enforcement surface landed in this same arc?_ If yes,
  proceed.
...
- New principles are predominantly _sharpenings_ of existing
...
surface is a candidate for _deferral_, not for landing. The deferral
...
- **2026-05-04 amendment — doctrine without enforcement is benefit-
  ...
  un-enforced principles as _incomplete_. The amendment sharpens
  ...
  tightens correspondingly: at maturity, _is the enforcement surface
  landed in this same arc?_ is the test, and "later" is the wrong

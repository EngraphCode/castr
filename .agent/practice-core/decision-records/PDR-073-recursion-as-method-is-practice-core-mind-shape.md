...
- The metacognition directive enacts recursion as method in three
  named layers: _thoughts → reflections → insights_. Each layer reads
...
recognition at session-close: _there is no mind without recursion_.
...
- **Cognition scale** — the metacognition directive's three-layer
  structure (_thoughts → reflections → insights_). Each layer reads
...
The aphorism _there is no mind without recursion_ is the naming
...
- **Cross-instance topology** — the same Practice Core substance
  ...
  topology is the property. This is the framing's _predicted_

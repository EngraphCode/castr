...
- **Moment 1 — Pre-positioning**: outgoing marshal broadcasts a
  narrative event with the conventional title _"Commit Marshal
  pre-positioning: \<outgoing\> → \<incoming\>"_ carrying the queue
...
- **Moment 2 — Active-acknowledgement**: incoming marshal broadcasts
  ...
  title _"Commit Marshal role acknowledgement: \<incoming\> from
  \<prior\>"_, referencing the pre-positioning event via

...
- PDR-028 introduces **`Source plane: <plane>`** as an inline
  ...
  _originated from_ a particular plane of memory (typically
  executive; potentially others as the convention extends).
- PDR-029 introduces **`cross_plane: true`** as a frontmatter
  field on patterns, marking that a pattern _spans across_
...
**Origin** — _where did this observation come from?_
...
**Span** — _which planes does this artefact touch?_
...
**Impact** — _which higher-permanence plane does this
lane-level work affect?_ (Added 2026-04-21 for catalogue
...
This PDR is agnostic about _which_ planes exist. The

...
| [PDR-096](PDR-096-bring-the-iceberg-transplant-completeness.md)                      | Bring the Iceberg — A Transplanted Capability Is Complete Only When Its Supporting Infrastructure Resolves  | Accepted                                                                                    |
| [PDR-097](PDR-097-dependency-currency-for-a-types-codegen-library.md)                | Dependency Currency for a Types/Codegen Library — Split by Risk, Classify by Call-Site, Prove Consumer-Side | Accepted                                                                                    |
...
| [PDR-124](PDR-124-multi-agent-audit-harness.md)                                      | Multi-Agent Audit Harness — Ground Truth First, Adversarial Verify, Completeness Critic                     | Accepted                                                                                    |
| [PDR-125](PDR-125-adversarial-verification-of-delegated-work.md)                     | Adversarial Verification of Delegated Work — Acceptance Means Verified                                      | Accepted                                                                                    |
| [PDR-126](PDR-126-machine-identities-for-agent-fleets.md)                            | Machine Identities for Agent Fleets — Split the Bypass-Holder from the Daily-Driver                         | Accepted                                                                                    |
| [PDR-140](PDR-140-we-do-not-discard-information.md)                                  | We Do Not Discard Information — the Conservation Invariant                                                  | Adopted                                                                                     |
| [PDR-141](PDR-141-compound-agent-composition-invocation-and-dissolution.md)          | Compound-Agent Composition, Invocation, and Information-Preserving Dissolution                              | Adopted                                                                                     |
| [PDR-142](PDR-142-three-tier-fleet-composition.md)                                   | Three-Tier Fleet Composition — Correlation-Distance Tiers, Atomic Judgements, Code Aggregation              | Adopted                                                                                     |

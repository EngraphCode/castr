...
PDR names the _shape_ of that enforcement.

The biological metaphor is load-bearing. An immune system is not a
fence; it is a _layered detection-and-response system_ that catches
...
structure, file diff shape) that can be detected mechanically _before_
...
Innate immunity is intentionally _broad and fast_. It produces some
...
Adaptive immunity is intentionally _narrow and slow_. It produces

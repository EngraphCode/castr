...
common move is to write a short paragraph of _justification_ that
...
justification (_"cross-cutting infrastructure rather than
axis-specific telemetry"_) and continued. The user asked: _"do we
need to call out the existence of cross-axis concerns explicitly?"_
...
The pattern: when an agent finds itself writing prose to _justify_
...
_habit_. Reviewer agents and consolidation passes can include the
question _"are any structural choices justified by prose rather
than category?"_ as part of their walk.
...
(e.g. _"axis A1 in collection C wants justification — investigate
whether C has a missing axis"_). The candidate trigger is owner

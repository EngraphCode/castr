...
upstream cognitive shape at the _application_ end of the
...
1. **Pre-action first-principles checkpoint.** Before applying
   a doctrine answer, the agent asks: _what kind of thing is in
   front of me, and is this rule shaped for it?_ If the
...
2. **Recurrence diagnostic.** When the same doctrine answer is
   ...
   failure mode and asks: _what is the upstream cause of this
   signal recurring?_

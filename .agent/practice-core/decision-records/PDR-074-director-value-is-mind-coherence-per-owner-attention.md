...
role; it did not name what makes a Director _effective_ in it.
...
- Directors who freeze the team behind a single point of control
  invisibly — without articulating _why_ — fail an autonomy
...
1. _Holding for owner-attention coherence_ — silent default.
2. _Holding for gate-clear / cascade-clear_ — silent default.
3. _Holding open for substrate work: \<authorised standing list\>_ —
...
surface: _can the team resolve this via reviewer-dispatch, sidebar,
or vote?_ If yes, route to substrate; only escalate to owner with
...
_slice + substrate authority + criteria for fit_; let agents
...
P5. **Director self-selection protocol** — _deferred to pending-graduations
entry 6 (`trigger: candidate`)_. This primitive had zero supporting

...
- **2026-05-09 amendment — per-session closure owns the loop
  ...
  - **The diagnostic is closure discipline, not loop cost.** When
    fitness goes hard or distilled bloats, the question is _which
    sessions skipped closure_ — not _the loop is overweight again,
    queue another graduation pass_.
  ...
  - **Reactive graduation passes are recovery work, not
    ...
    consolidation, the pass exists _because_ closure was skipped in
...
- **2026-04-29 amendment — knowledge preservation is absolute and is
  ...
  - **The deferral-honesty discipline (Session 6 amendment) governs
    deferred _work_, not deferred _capture_.** A constraint or
...
- **2026-04-26 amendment — owner-directed pause is a load-bearing
  ...
  first question — _could it be simpler without compromising
  quality?_ — at the workstream-sequencing level, not just within a
  single workstream.
...
- **2026-04-22 Session 6** (Accepted): **deferral-honesty
  ...
  or consolidation close is _honest_ when it satisfies three
...
failure: _"budget consumed"_, _"out of scope"_, _"for later"_,
_"next session"_, _"ran out of time"_ — these are convenience

...
`assumptions-expert`, or any reviewer whose lens is _"what is
wrong with this design"_ rather than _"how can this design be
improved"_) surfaces **BLOCKING findings** on a plan body or
...
are _correct against an assumed frame_ but where the assumed
...
claim was wrong — _the-frame-was-the-fix_ pattern, in PDR-015's

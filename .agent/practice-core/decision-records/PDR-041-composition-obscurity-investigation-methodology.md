...
methodology principle: this PDR addresses the _investigation
discipline_ when external systems catch what local gates miss; PDR-039
addresses the _response discipline_ once a local gap is named);
...
is _composition cost_, not bug cost. Every layer makes a defensible
...
The methodology is not a checklist; it is a _priority order_. Step 1

 ...
 */
export function getOperationIdForEndpoint(method: string, path: string): string | undefined {
 ...
 */
export function getPrimaryStatusForOperation(operationId: string): string | undefined {

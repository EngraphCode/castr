...
1. Severity: high
   File: [index.ts](../../../lib/src/schema-processing/parsers/json-schema/index.ts#L43)
   File: [json-schema-writer.document.ts](../../../lib/src/schema-processing/writers/json-schema/json-schema-writer.document.ts#L48)
   File: [scenario-5-json-schema-roundtrip.integration.test.ts](../../../lib/tests-transforms/__tests__/scenario-5-json-schema-roundtrip.integration.test.ts#L7)
   File: [scenario-6-zod-via-json-schema.integration.test.ts](../../../lib/tests-transforms/__tests__/scenario-6-zod-via-json-schema.integration.test.ts#L5)
...
2. Severity: high
   File: [json-schema-parser.core.ts](../../../lib/src/schema-processing/parsers/json-schema/json-schema-parser.core.ts#L47)
   File: [json-schema-parser.types.ts](../../../lib/src/schema-processing/parsers/json-schema/json-schema-parser.types.ts#L24)
   File: [json-schema-parser.normalization.refs.ts](../../../lib/src/schema-processing/parsers/json-schema/normalization/json-schema-parser.normalization.refs.ts#L25)
   File: [json-schema-parser.object-fields.ts](../../../lib/src/schema-processing/parsers/json-schema/json-schema-parser.object-fields.ts#L70)
   File: [json-schema-and-parity-acceptance-criteria.md](../../../.agent/acceptance-criteria/json-schema-and-parity-acceptance-criteria.md#L11)
...
3. Severity: high
   File: [json-schema-object.ts](../../../lib/src/schema-processing/writers/shared/json-schema-object.ts#L90)
   File: [schema.ts](../../../lib/src/schema-processing/ir/models/schema.ts#L420)
   File: [json-schema-fields.ts](../../../lib/src/schema-processing/writers/shared/json-schema-fields.ts#L48)
   File: [json-schema-fields.ts](../../../lib/src/schema-processing/writers/shared/json-schema-fields.ts#L197)
   File: [json-schema-2020-12-fields.ts](../../../lib/src/schema-processing/writers/shared/json-schema-2020-12-fields.ts#L32)
   ...
   File: [scenario-7-multi-cast.integration.test.ts](../../../lib/tests-transforms/__tests__/scenario-7-multi-cast.integration.test.ts#L155)
   File: [json-schema.char.test.ts.snap](../../../lib/src/characterisation/__snapshots__/json-schema.char.test.ts.snap#L3)
...
- The main drift is temporal and contractual rather than purely implementational. [phase-4-json-schema-and-parity.md](../../../.agent/plans/current/complete/phase-4-json-schema-and-parity.md#L43) still says the parser and parity rig are complete and green, and [json-schema-and-parity-acceptance-criteria.md](../../../.agent/acceptance-criteria/json-schema-and-parity-acceptance-criteria.md#L3) still points at a nonexistent future-plan path.
- The acceptance criteria also overstate or contradict live doctrine in several places: they still allow metadata-directed lossy fallback and `components.schemas` bundle language in [json-schema-and-parity-acceptance-criteria.md](../../../.agent/acceptance-criteria/json-schema-and-parity-acceptance-criteria.md#L20), which conflicts with ADR-041's custom-rescue rule and the live `$defs` writer surface.
- Pack 4 closeout rewrote [json-schema-parser.md](../../../.agent/plans/current/complete/json-schema-parser.md#L1) from a stale parser-build plan into a historical remediation-context record so the next implementation slice cannot accidentally resume the wrong story.
...
- [json-schema-parser.md](../../../.agent/plans/current/complete/json-schema-parser.md) must not be resumed as if it were a ready-to-run parser implementation plan; it now stands as a historical remediation-context record.

...
1. Severity: high
   ...
   File: [lib/src/rendering/generate-from-context.ts](../../../lib/src/rendering/generate-from-context.ts)
   File: [lib/src/schema-processing/context/template-context.ts](../../../lib/src/schema-processing/context/template-context.ts)
   File: [lib/src/cli/helpers.ts](../../../lib/src/cli/helpers.ts)
...
2. Severity: medium
   File: [lib/package.json](../../../lib/package.json)
   File: [lib/src/cli/index.ts](../../../lib/src/cli/index.ts)
   File: [lib/src/characterisation/cli.char.test.ts](../../../lib/src/characterisation/cli.char.test.ts)
...
3. Severity: medium
   File: [lib/src/index.ts](../../../lib/src/index.ts)
   File: [lib/src/public-api-preservation.test.ts](../../../lib/src/public-api-preservation.test.ts)
...
- The package boundary itself is reasonably disciplined: [`lib/package.json`](../../../lib/package.json) exposes only `.`, `./cli`, and `./parsers/zod`, and [`lib/.dependency-cruiser.cjs`](../../../lib/.dependency-cruiser.cjs) enforces barrel-only seams across `schema-processing/*`.
...
- Public docs remain materially drifted from repo truth, especially [`README.md`](../../../README.md) and [`docs/API-REFERENCE.md`](../../../docs/API-REFERENCE.md).
...
- [`json-schema-parser.md`](../../../.agent/plans/current/complete/json-schema-parser.md) remains historical remediation context; Pack 4 still owns its revalidation decision.

...
1. Severity: high
   File: [generate-from-context.ts](../../../lib/src/rendering/generate-from-context.ts#L40)
   File: [generate-from-context.ts](../../../lib/src/rendering/generate-from-context.ts#L180)
   File: [index.ts](../../../lib/src/schema-processing/writers/typescript/index.ts#L44)
   File: [index.ts](../../../lib/src/schema-processing/writers/typescript/index.ts#L138)
   File: [options.char.test.ts](../../../lib/src/characterisation/options.char.test.ts#L100)
...
2. Severity: high
   File: [generate-from-context.ts](../../../lib/src/rendering/generate-from-context.ts#L44)
   File: [generate-from-context.ts](../../../lib/src/rendering/generate-from-context.ts#L158)
   File: [helpers.ts](../../../lib/src/cli/helpers.ts#L100)
   File: [API-REFERENCE.md](../../../docs/API-REFERENCE.md#L88)
...
3. Severity: high
   File: [template-context.mcp.schemas.from-ir.ts](../../../lib/src/schema-processing/context/mcp/schemas/template-context.mcp.schemas.from-ir.ts#L183)
   File: [template-context.mcp.schemas.from-ir.ts](../../../lib/src/schema-processing/context/mcp/schemas/template-context.mcp.schemas.from-ir.ts#L233)
   File: [schema.ts](../../../lib/src/schema-processing/ir/models/schema.ts#L108)
   File: [schema.ts](../../../lib/src/schema-processing/ir/models/schema.ts#L230)
   File: [schema.ts](../../../lib/src/schema-processing/ir/models/schema.ts#L301)
   File: [schema.ts](../../../lib/src/schema-processing/ir/models/schema.ts#L356)
   File: [schema.ts](../../../lib/src/schema-processing/ir/models/schema.ts#L418)
...
4. Severity: high
   File: [FIXTURES.md](../../../lib/tests-generated/FIXTURES.md#L7)
   File: [validation-harness.ts](../../../lib/tests-generated/validation-harness.ts#L153)
   File: [validation-harness.ts](../../../lib/tests-generated/validation-harness.ts#L181)
   File: [validation-harness.ts](../../../lib/tests-generated/validation-harness.ts#L262)
   File: [type-check-validation.gen.test.ts](../../../lib/tests-generated/type-check-validation.gen.test.ts#L68)
   File: [runtime-validation.gen.test.ts](../../../lib/tests-generated/runtime-validation.gen.test.ts#L69)
   File: [templating.unit.test.ts](../../../lib/src/rendering/templating.unit.test.ts#L160)
...
5. Severity: medium
   File: [template-context.ts](../../../lib/src/schema-processing/context/template-context.ts#L120)
   File: [template-context.ts](../../../lib/src/schema-processing/context/template-context.ts#L129)
   File: [inline-schemas.ts](../../../lib/src/schema-processing/context/schemas/inline-schemas.ts#L16)
   File: [inline-schemas.ts](../../../lib/src/schema-processing/context/schemas/inline-schemas.ts#L36)
   File: [template-context.test.ts](../../../lib/src/schema-processing/context/template-context.test.ts#L101)
...
- [MCP_INTEGRATION_GUIDE.md](../../../docs/MCP_INTEGRATION_GUIDE.md#L41) materially overstates the current MCP public surface. It documents `@engraph/castr` as the CLI binary, a manifest-only mode, `openApiDoc: './petstore.yaml'` as a programmatic argument, `result.mcpTools` on the generation result, and a `{ "tools": [...] }` manifest shape. The live CLI instead writes an array of `{ tool, httpOperation, security }` entries and still generates an output file alongside the manifest; see [index.ts](../../../lib/src/cli/index.ts#L140) and [cli.char.test.ts](../../../lib/src/characterisation/cli.char.test.ts#L306).
- [API-REFERENCE.md](../../../docs/API-REFERENCE.md#L95) still advertises `templatePath` as part of the programmatic surface even though Pack 6 found no live implementation path for it.
...
- [json-schema-parser.md](../../../.agent/plans/current/complete/json-schema-parser.md) remains historical remediation context; the review sweep still decides the next implementation slice rather than reactivating any queued implementation story on assumption.

...
1. Severity: high
   File: [schema.components.ts](../../../lib/src/schema-processing/ir/models/schema.components.ts#L25)
   File: [index.ts](../../../lib/src/schema-processing/parsers/openapi/index.ts#L80)
   File: [parser-field-coverage.integration.test.ts](../../../lib/tests-transforms/__tests__/parser-field-coverage.integration.test.ts#L122)
   File: [openapi-writer.components.ts](../../../lib/src/schema-processing/writers/openapi/components/openapi-writer.components.ts#L315)
   File: [writer-field-coverage.integration.test.ts](../../../lib/tests-transforms/__tests__/writer-field-coverage.integration.test.ts#L109)
   File: [openapi-acceptance-criteria.md](../../../.agent/acceptance-criteria/openapi-acceptance-criteria.md#L166)
   File: [ADR-030-full-openapi-syntax-support.md](../../../docs/architectural_decision_records/ADR-030-full-openapi-syntax-support.md#L28)
...
- The runtime seam itself is physically clean: [orchestrator.ts](../../../lib/src/shared/load-openapi-document/orchestrator.ts#L44) owns bundling, declared-version validation, and upgrade before the parser path begins, and the doctor is not imported into parser or writer flows.
- Loader and architecture docs still describe that seam inconsistently. [index.ts](../../../lib/src/shared/load-openapi-document/index.ts), [scalar-pipeline.md](../../../docs/architecture/scalar-pipeline.md#L80), [input-pipeline.char.test.ts](../../../lib/src/characterisation/input-pipeline.char.test.ts#L113), and [bundled-spec-assumptions.char.test.ts](../../../lib/src/characterisation/bundled-spec-assumptions.char.test.ts#L32) still carry stale stage-order or SwaggerParser-era language even though the live implementation is now Scalar-only.
...
- [json-schema-parser.md](../../../.agent/plans/current/complete/json-schema-parser.md) remains historical remediation context until Pack 4 explicitly decides whether that workstream still fits the reviewed architecture.

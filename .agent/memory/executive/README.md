...
| [`invoke-code-experts.md`](invoke-code-experts.md)                                 | Reviewer/expert catalogue, layered triage, worked examples — the roster behind the [`invoke-reviewers`](../../rules/invoke-reviewers.md) firing rule | ✅ **Landed (2026-06-18)** — castr's 6-reviewer roster                                                                                                                                                                                |

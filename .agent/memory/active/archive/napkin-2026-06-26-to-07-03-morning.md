# Napkin archive — 2026-06-26 → 2026-07-03 (morning sessions)

Rotated 2026-07-03 at the Fiery Flaring Bellows session close. Every section here was
processed before rotation: the 2026-06-26/27/28 window by the 2026-06-28 deep consolidation,
and the 2026-07-03 morning sections (Penumbral Slipping Moth ×2, Windswept Winging Cliff
parts 1–2) by the 2026-07-03 dedicated consolidation pass (distilled merges, commit-skill and
testing-strategy graduations, backflow-ledger rows, register items — the permanent homes are
the record). Conserved in full, never trimmed.

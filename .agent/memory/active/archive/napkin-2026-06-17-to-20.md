# Napkin archive — 2026-06-17 to 2026-06-20 (Phase 7 + Phase 8-partial)

Rotated from the active napkin 2026-06-20 after the session graduated its
cross-session lessons to [`../distilled.md`](../distilled.md). Raw capture is
preserved here as evidence; the durable substance lives in `distilled.md`,
`reference-closure.md`, and the phase commits. Conserved, not trimmed.

# Napkin archive — 2026-06-20 → 2026-06-21

> Rotated 2026-06-26 (Eclipsed Lurking Moth / 1dfcd1, dedicated consolidation).
> Processed capture from the 2026-06-20 (Oak parity Tranche 1, FIRST-RUN
> collaboration dogfood, pin-model reframe, Phase-8 tasks, statusline,
> parity-program planning) and 2026-06-21 (dependency-currency dev-tooling +
> DC1/DC2, Oak parity Tranche 2, dependency-currency plan) windows. Behaviour-
> changing lessons were merged into `distilled.md`; the FIRST-RUN friction
> worklist (F1–F12/N1–N12) was relocated to
> `.agent/plans/transplant/first-run-friction-inventory.md` as the friction-fix
> lane's controlling plan. The 2026-06-20 pin-model reframe is retained here as
> **history** — it was superseded 2026-06-26 by the live-`main` Oak read model
> (no pin). Archived verbatim; never trimmed.

...
use_this_when: 'a reviewer recommends replacing a type construct with a wider one (e.g. Record<string, unknown> to z.unknown()) citing a forbidden-constructs rule'
category: agent
proven_in: imported
status: proven

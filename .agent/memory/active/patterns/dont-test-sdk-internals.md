---
name: "Don't test SDK internals"
polarity: pattern
use_this_when: 'writing a test whose assertion can only fail when a third-party SDK changes, not when your own code changes'
category: testing
proven_in: imported
barrier_met: true
source_sessions:
...
when the SDK changes (not when your own code changes), the test is
...
1. What does your code put in? (test the projection/config)

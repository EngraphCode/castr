...
polarity: pattern
use_this_when: "a peer agent's active claim conflicts with the scope your session needs and you are tempted to escalate to the owner instead of a directed sidebar with a deadline and default action"
category: agent
status: proven
...
The protocol does **not** prevent a _third_ agent entering the

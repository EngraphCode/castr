...
polarity: pattern
use_this_when: 'about to start complex implementation work where specialist review could catch architectural or protocol issues at the plan stage before any code is written'
category: process
proven_in: imported
status: proven
...
**Session 2026-04-11**: 12 pre-implementation findings on a

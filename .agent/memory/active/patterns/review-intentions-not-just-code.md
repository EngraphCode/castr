...
polarity: pattern
use_this_when: 'about to implement a complex change where a specialist could review the design intent and alternatives before any code is written'
category: process
status: proven
...
`#222222`, the real brand uses `#287C34`). Two-round structure with

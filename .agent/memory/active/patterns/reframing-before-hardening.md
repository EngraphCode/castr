...
polarity: pattern
use_this_when: 'a blocking review lands many findings and you are about to absorb them one by one without first asking whether the central design claim is the right one'
category: process
status: provisional
...
review's substantive signal — _the frame is wrong_ — is dissolved
...
2. **Ask the reframe question.** Is the central design claim — the
   ...
   together, suggest about the _frame_?" "If I had no commitments,

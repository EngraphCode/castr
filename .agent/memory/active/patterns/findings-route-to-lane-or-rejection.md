...
polarity: pattern
use_this_when: 'closing out a reviewer matrix where every finding must be actioned, routed to a named owning lane, or explicitly rejected — never deferred without a lane'
category: process
status: proven

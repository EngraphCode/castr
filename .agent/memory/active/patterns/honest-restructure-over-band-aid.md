...
question _"what is the gate's signal telling me about my design?"_
...
(_structurally active_ via synthetic unit tests + _operationally
active_ when t2 lands the data file via the typed loader).
...
band-aid: _"is the gate signalling a real design concern, or is it
arbitrary?"_ If real (which it nearly always is in this repo's

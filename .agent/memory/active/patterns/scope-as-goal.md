...
use_this_when: 'a work-list or reviewer scope is full and structured and you are treating completing it as the goal when the prompt scope may not equal the goal scope'
category: process
status: provisional
...
7. Agent realises the work-list was instrumental — its purpose was
   to _unblock_ the goal, not _be_ the goal.
...
- **Notice the closure-as-progress signal.** If a work-list is
  ...
  that is the moment to ask "what is the _goal_, and have I asked
  about _that_?"

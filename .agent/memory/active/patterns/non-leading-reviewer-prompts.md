...
polarity: pattern
use_this_when: 'writing a reviewer prompt and about to phrase it in a way that pre-supposes the answer, narrowing the finding surface'
category: agent
status: proven
...
- "Review this for compliance with one named rule." — pre-supposes that
  rule is the relevant lens; the reviewer won't catch violations of others.
...
(amendment convention, delegates-seam divergence, L-7 script

...
polarity: pattern
use_this_when: 'assessing what a system uses from a library and tempted to frame the conclusion before reading the composition root and load-bearing code'
category: process
status: proven

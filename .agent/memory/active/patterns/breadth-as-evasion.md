...
use_this_when: 'a direct verification question has a clean yes/no answer and the impulse is to answer with a table, list, or adjacent context instead of the answer'
category: process
status: provisional
...
arranged to _appear_ answer-shaped without containing the answer.

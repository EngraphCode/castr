...
2. Ask: who else will encounter this decision, and how soon?
   ...
   - Reviewer findings cluster around _"where is this documented
     canonically?"_ → strong ADR-worthy signal, write it.
...
Promoting it to a repo ADR made the decision discoverable, linked it
into the existing decision mesh, and unblocked the next vendor-CLI
adoption plan from citing a concrete authority. The ADR itself is ~200 lines — larger

...
polarity: pattern
use_this_when: 'a team session has N peers against N+1 file-disjoint slices and you must decide whether the coordinator takes a slice rather than forcing a peer to double up'
category: agent
status: provisional
...
- `.agent/skills/start-right-team/` — the team-bootstrap

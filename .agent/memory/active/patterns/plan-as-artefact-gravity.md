...
A remediation plan is intended as an _execution document_: it
...
them into _self-referential artefacts_ instead. Symptoms:
...
- A plan whose session-history _is_ the load-bearing artefact

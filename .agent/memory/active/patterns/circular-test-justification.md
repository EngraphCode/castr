...
use_this_when: 'production code appears live only because tests call it, and the tests exist only because the code exists — neither serves an external consumer'
category: testing
proven_in: imported

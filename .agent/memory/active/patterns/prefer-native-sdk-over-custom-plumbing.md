---
name: 'Prefer Native SDK Over Custom Plumbing'
polarity: pattern
use_this_when: 'a library or SDK provides a capability natively and you are maintaining custom plumbing that reimplements it'
...
A vendor SDK provided custom per-handler MCP

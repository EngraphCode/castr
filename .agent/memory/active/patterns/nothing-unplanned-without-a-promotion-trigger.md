...
polarity: pattern
use_this_when: "scope-spanning analysis surfaces an unplanned item and you are about to park it 'for later' without a plan placement or a named promotion trigger"
category: process
status: proven
...
- Two items (business/product metrics, content

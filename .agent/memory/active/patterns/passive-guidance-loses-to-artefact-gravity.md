...
Chip and Dan Heath name the mechanism in _Decisive_ (ch. 9,
"Prepare to Be Wrong") and _Switch_ (ch. 8, "Shape the Path").
...
also to _generative_ artefacts — templates, scaffolds, plan
...
- **Perturbation-Mechanism Bundle PDR** — [PDR-029](../../../practice-core/decision-records/PDR-029-perturbation-mechanism-bundle.md)
  ...
  _active means markdown-ritual, not code execution_, and the

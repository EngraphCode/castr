...
3. Prefer the `.docx` over the markdown or PDF when you need to recover links.
   ...
   positionally _stronger_ — recovery surface. Current exports (verified
...
- Bibliography entries are `- <a id="ref-N"></a>**[N]** <https://url/>`
  ...
  (e.g. _Sentry product documentation_, _PostHog pricing_, _Third-party
  reviews & community_). Order groups so the report's primary subject leads.
...
signal worth chasing. 12. Do not let DOCX-first or pandoc-first conversions overrule a better
markdown scaffold merely because they surface more URLs. 13. After automated conversion, restore markdown block boundaries around
...
- Turning a requested clean copy into a report _about_ the document instead of

...
polarity: pattern
use_this_when: 'about to write a technical claim into a plan, TSDoc, or governance doc carried from session notes without re-checking it against the primary source'
category: process
proven_in: imported
status: active

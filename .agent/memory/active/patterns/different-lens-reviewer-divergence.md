...
polarity: pattern
use_this_when: 'multiple reviewers dispatched in parallel against one artefact return divergent findings and you are tempted to read the divergence as redundancy-failure or noise'
category: agent
status: proven
...
- [`reviewer-widening-is-always-wrong`](reviewer-widening-is-always-wrong.md) —
  scope discipline; divergence is about _finding-set_ coverage, not
...
non-trivial artefact and the convergence is _not_ a depth-of-concern

...
| **Remediation parallel program (EXECUTING)**        | `fix/remediation-*` lanes off `main` + `docs/remediation-program-record` (PR #10) | [00-parallel-execution-program.md](../../plans/remediation/00-parallel-execution-program.md)                                         | Waves in flight — recompute the live PR list with `gh pr list` (hand-enumeration retired, PR #10 review round 9); per-lane fix rounds + review-thread resolution ongoing; feature slice integrates after L-D merges                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                | claude-code / claude-fable-5 / Sylvan Flowering Branch (orchestrator — Moment-2 transfer `c3807e39`) `2026-07-18`; claude-code / claude-fable-5 / Stormbound Circling Kite (orchestrator) `2026-07-18`; claude-code / claude-fable-5 / Highland Spiralling Summit (orchestrator) `2026-07-18`                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                | See [thread record](threads/remediation-parallel-program.next-session.md) — **successor: read its Danger List first** |

...
**drain DONE this pass — 2026-06-26 (Eclipsed Lurking Moth, `dedicated-knowledge-curation`).** The cross-session
buffers handed over by the Stratospheric Kiting Breeze session (c56a0f, which closed in `session-completion` mode
only and ceded the drain via comms) were drained. **napkin rotated** (846→~150): the 2026-06-20/06-21 windows
archived to [`../active/archive/napkin-2026-06-20-to-21.md`](../active/archive/napkin-2026-06-20-to-21.md), three
not-yet-conserved lessons merged into `distilled.md`, and the **FIRST-RUN friction worklist (F1–F12/N1–N12)
relocated to its permanent home** [`../../plans/transplant/first-run-friction-inventory.md`](../../plans/transplant/first-run-friction-inventory.md)
...
`dependency-currency-discipline` remains event-gated (graduates at DC3–DC5 lane-close; owner-decided 2026-06-21,
insight conserved in distilled + plan); the two PDR-shaped candidates (`dissolve-owner-gating-with-four-lenses`,
instance-2 fired/DUE, + `transplant-completeness`, owner-named) are **at owner decision** (step 7a/15 require owner
approval for Core surfaces; recommendation-first digest presented). **Fitness:** the residual CRITICAL

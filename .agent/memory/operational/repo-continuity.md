...
| **Proof-programme loop review (IN PROGRESS)**       | `claude/funny-wright-9wfdnx` off `main` | [plans/active/proof-programme-loop-review.md](../../plans/active/proof-programme-loop-review.md) (legs R1–R6 + scope guard; promoted current/ → active/ 2026-08-24) | Owner-commissioned 2026-08-24: review the loop's plan, queues, routine definition, and associated skills — reflexes, not paperwork (runaway/stall modes, exit-criteria reachability, instruments active-not-prose). Distinct from the proof-programme thread, which RUNS the loop; this seat must not execute queue items. Sibling: the Slack Watcher estate review runs in OCE in parallel                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                        | claude-code / claude-fable-5 / Flamebright Burning Caldera (reviewer — legs R1–R6) `2026-08-24`                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                              | See [thread record](threads/proof-programme-review.next-session.md) — opening statement inside |
| **Proof programme (autonomous loop)**               | per-slice branches off `main`           | [proof-programme/parent-plan.md](../../plans/proof-programme/parent-plan.md) (queue + operating contract; routine-prompt.md is the firing brief)                    | Q-00 ✅ + Q-01 ✅ (loop armed, three firings/day); Q-02 ✅ COMPLETE (evidence record in the parent plan; PR #35 carries the landing — base merged, all 30 review threads disposed per ADR-051 clause 4 with round-17 residuals queued as Q-17, merged at CI green 2026-08-23); QD-5 reporting design MERGED (PR #38) + QD-6 playbook/ballot + QD-8 mobile-alert amendment MERGED (PR #39, `68a2e2c`) 2026-08-23; QD-7 DIRECTED (Slack connector + The Watcher advisory/relay tier, ADR-051 clause 7 carve-out, 2026-08-23 — capability probe queued to Q-15); queue state lives in the parent-plan frontmatter                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                     | claude-code / claude-fable-5 / Fruited Swaying Leaf (scheduled firing — PR #35 drive to merge, Q-17 carry-forward) `2026-08-23`; claude-code / claude-fable-5 / Cindery Kindling Lava (executor — QD-5/QD-6 landings) `2026-08-23`                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                           | See [thread record](threads/proof-programme.next-session.md)                                   |

...
export const tsRules: Linter.RulesRecord = {
        ...
        "error",
        {
            types: {
                ...
                "Record<string, unknown>": {
                    message:
                        "Avoid Record<string, unknown>. Use an existing internal or library type where possible. If you are working on the Engraph SDK or MCP server, use a type and type guard derived from the compile time data structures packages/sdks/engraph-curriculum-sdk/src/types/generated/api-schema.",
                },

                // Common variants you might also want to block
                "Record<string, undefined>": {
                    message:
                        "Avoid Record<string, undefined>. Use an existing internal or library type where possible. If keys are optional, prefer Partial. If you are working on the Engraph SDK or MCP server, use a type and type guard derived from the compile time data structures packages/sdks/engraph-curriculum-sdk/src/types/generated/api-schema.",
                },
                "Readonly<Record<string, undefined>>": {
                    message:
                        "Avoid Readonly<Record<string, undefined>>. Use an existing internal or library type where possible. If you are working on the Engraph SDK or MCP server, use a type and type guard derived from the compile time data structures packages/sdks/engraph-curriculum-sdk/src/types/generated/api-schema.",
                },
                "Record<PropertyKey, undefined>": {
                    message:
                        "Avoid Record<PropertyKey, undefined>. Use an existing internal or library type where possible. If you are working on the Engraph SDK or MCP server, use a type and type guard derived from the compile time data structures packages/sdks/engraph-curriculum-sdk/src/types/generated/api-schema.",
                },
            },
        },
    ],
    ...
    "no-restricted-syntax": [
        "error",
        {
            ...
            message: 'Avoid export * from "module" syntax to improve tree shaking. Use named exports instead.',
        },
    ],
};
...
export const baseConfig = defineConfig(
    ...
    {
        files: ["**/*.test.ts", "**/*.test.tsx", "**/*.spec.ts", "**/*.spec.tsx", "**/test-*.ts", "**/__tests__/**"],
        rules: {
            ...testRules,
        },
    },

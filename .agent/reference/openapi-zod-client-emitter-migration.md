...
- **Persist the Caster Model:** emit an optional JSON artefact (or provide programmatic access) so that future tooling can regenerate OpenAPI from generated clients without re-parsing TypeScript.
...
> Keep naming, grouping, and “complexity-based inlining” decisions _outside_ the emitter. The emitter should simply print what the Caster Model describes.
...
import type { FileUnit } from '@engraph/castr/internal/file-model';

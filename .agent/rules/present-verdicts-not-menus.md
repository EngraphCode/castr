...
`feedback_answer_verification_questions_directly` (origin 2026-04-24) —
per-user auto-memory, templated home
`~/.claude/projects/<project>/memory/` — together with
[PDR-057](../practice-core/decision-records/PDR-057-empirical-answerability.md)
...
The reliable tell: _could the agent rank these options by evidence
already in context?_ If yes, the quiz is evasion. Either commit to the

...
Operationalises the **no machine-local paths** principle: every path in
a version-controlled file must resolve to the same meaningful target on
...
grep -rn -E "/Users/[a-z0-9_-]+/|/home/[a-z0-9_-]+/|C:\\\\Users\\\\" \
  ...
  .agent/ docs/ scripts/ lib/ agent-tools/ \

...
- `session-handoff` step 6 — mirror at session close.
- `consolidate-docs` step 3 — cross-platform ingestion at
  thread-scoped depth.
...
Owner-stated 2026-05-17 after a recurrence: _"part of the function
...
At every `session-handoff` step 6 and `consolidate-docs`
...
is a consolidation-time activity (`consolidate-docs` step 3),

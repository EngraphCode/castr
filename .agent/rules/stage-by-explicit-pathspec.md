...
3. **The act of staging stops being deliberate.** Once wildcard
   staging is normalised, the question _"which of these belongs in
   this commit?"_ never gets asked, and the commit boundary becomes
   accidental.
...
enable. Owner correction first graduated _Stage by explicit pathspec_
...
— it is a _behavioural commitment one side keeps on the other side's
behalf_. The applying side carries the discipline; the non-applying

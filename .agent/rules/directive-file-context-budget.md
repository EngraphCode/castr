...
Files under `.agent/directives/` are:
...
This is the standard surface-the-conflict discipline applied to a
standing rule: name the conflict, offer the split, proceed only on
express override.

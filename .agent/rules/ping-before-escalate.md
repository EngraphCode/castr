...
with subject _"Liveness check: are you still active?"_) and wait
...
The cure shape is _"verify silence is silence before naming it
retirement"_. PDR-078's threshold rule is a structural permission,

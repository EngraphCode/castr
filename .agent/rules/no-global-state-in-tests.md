...
See `.agent/directives/testing-strategy.md` for castr's full test methodology. Origin doctrine: Oak ADR-078 (dependency injection for testability; cross-host).

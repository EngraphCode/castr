...
disproven shape out of the _code_; this rule keeps it out of the _writing_.
...
governance doc, rule, README, or code comment stating what the system _is_ and
_does_. When you remove a wrong idea from such prose:

1. State the correct design in the positive: what the system _is_ and _does_.
...
_structural_ pattern (a negation bound to a dead concept), not a fixed
